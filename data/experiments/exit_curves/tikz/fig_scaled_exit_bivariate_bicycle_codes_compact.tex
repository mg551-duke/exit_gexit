...
\begin{tikzpicture}
\begin{axis}[
  name=scaledEXITBicycleAxisCompact,
  width=\linewidth,
  height=0.78\linewidth,
  title={Bivariate-bicycle derivatives},
...
\addlegendentry{gross $[[576,16]]$, scaled by $2.366$}
...
\addlegendentry{gross $[[2304,16]]$, scaled by $4.235$}
...
\addlegendentry{two-gross $[[1152,12]]$, scaled by $4.023$}
...
\addlegendentry{two-gross $[[4608,12]]$, scaled by $7.828$}
\end{axis}
\end{tikzpicture}
