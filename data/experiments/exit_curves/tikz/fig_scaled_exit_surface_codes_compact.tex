...
\begin{tikzpicture}
\begin{axis}[
  name=scaledEXITSurfaceAxisCompact,
  width=\linewidth,
  height=0.78\linewidth,
  title={Surface derivatives},
  title style={font=\scriptsize},
  xlabel={$e$},
  ylabel={$\widetilde g_X(e)$},
  xmin=0, xmax=1,
  ymin=-0.02, ymax=1.06,
  grid=both,
...
\addlegendentry{$d=7$, scaled by $20.5$}
...
\addlegendentry{$d=11$, scaled by $37$}
...
\addlegendentry{$d=21$, scaled by $101.9$}
...
\addlegendentry{$d=45$, scaled by $251.5$}
\addplot+[color=purple, mark=pentagon*, mark size=1.0pt, line width=0.65pt]
coordinates {(0.45,0.00729927007299) (0.47,0.197080291971) (0.5,1) (0.53,0.204379562044) (0.55,0.00729927007299)};
\addlegendentry{$d=75$, scaled by $405.1$}
\addplot+[color=brown, mark=otimes*, mark size=1.0pt, line width=0.65pt]
...
\addlegendentry{$d=251$, scaled by $2.07\times 10^{3}$}
\end{axis}
\end{tikzpicture}
